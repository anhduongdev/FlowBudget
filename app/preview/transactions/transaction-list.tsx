...
function toEditableTransaction(item: TransactionListItem): EditableTransaction {
  return {
    id: item.id,
    type: item.type,
    ...
    amount: item.amount,
    transactionDateIso: item.transactionDateIso,
    note: item.note,
  };
}
    ...
    <>
          ...
          <div className="space-y-3" key={group.dateIso}>
            ...
            <div className="flex justify-between items-center border-b border-outline-variant pb-2">
              <div className="flex items-center gap-2.5">
                <span className="text-4xl font-extrabold text-[#18448b]/10 leading-none">
      ...
      {selected && (
        <TransactionModal
          ...
          open
          transaction={toEditableTransaction(selected)}
        />
      )}
    </>
  );
